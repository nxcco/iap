...
# boundaries at the same N interior grid points used by set_up_problem. Used as
# the reference "true" answer to measure forward error in the solver experiments.
